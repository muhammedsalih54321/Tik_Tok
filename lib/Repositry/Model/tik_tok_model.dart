...
class Tiktokmodel {
    ...
    Tiktokmodel({this.code, this.msg, this.processedTime, this.data});
    ...
    static List<Tiktokmodel> fromList(List<Map<String, dynamic>> list) {
        return list.map((map) => Tiktokmodel.fromJson(map)).toList();
    }
...
class Data {
    ...
    Data({this.awemeId, this.id, this.region, this.title, this.cover, this.aiDynamicCover, this.originCover, this.duration, this.play, this.wmplay, this.size, this.wmSize, this.music, this.musicInfo, this.playCount, this.diggCount, this.commentCount, this.shareCount, this.downloadCount, this.collectCount, this.createTime, this.anchors, this.anchorsExtras, this.isAd, this.commerceInfo, this.commercialVideoInfo, this.itemCommentSettings, this.author});
    ...
    Data.fromJson(Map<String, dynamic> json) {
        ...
        if(json["wm_size"] is num) {
            wmSize = (json["wm_size"] as num).toInt();
        }
        ...
        if(json["collect_count"] is num) {
            collectCount = (json["collect_count"] as num).toInt();
        }
